...
// Close menu on click
var menuItems = document.getElementsByClassName('offcanvas-item');
...
function initMap() {
    ...
    var biscake = {lat: 40.653672, lng: -7.908282};
    // The map, centered at Uluru
    var map = new google.maps.Map(
        document.getElementById('map'), {zoom: 16, center: biscake});
    // The marker, positioned at Uluru
    var marker = new google.maps.Marker({position: biscake, map: map});
}